...
@section('content')
<div class="text-gray-900 leading-normal tracking-wider mt-10">
<div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
    ...
    <div id="profile"
        ...
        <div class="p-4 md:p-12 text-center lg:text-left">
            ...
            <div class="block  rounded-full shadow-xl mx-auto mt-28 h-48 w-48 bg-cover bg-center"
                style="background-image: url('/assets/image/rahman.jpg')"></div>

            <h1 class="text-3xl font-bold pt-8 lg:pt-0">Abdurrahman</h1>
            <div class="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-blue-700 opacity-25"></div>
            <p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
                <svg class="w-6 h-6 text-gray-800 dark:text-white mr-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
            ...
            <p class="pt-2 text-gray-600 text-xs lg:text-sm flex items-center justify-center lg:justify-start">
                ...
                </svg> Jln.Veteran III Tapos Kp.Cileungsi Ds.Cileungsi Rt.03/03 No.10 16720
            </p>
            <p class="pt-8 text-sm">1'm Abdurrahman or people often call me Rahman junior developer that bases on Wikrama Vocational High School</p>

            <div class="pt-12 pb-8 mt-2">
            ...
            <div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
                ...
                <a class="link" href="https://github.com/abdurrahman778" data-tippy-content="@github_handle">
                    <svg class="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
                        <title>GitHub</title>
                        <path
                ...
                <a class="link" href="https://instagram.com/rahmannn_778" data-tippy-content="@instagram_handle">
                    <svg class="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24"
                        xmlns="http://www.w3.org/2000/svg">
