...
class Data {
    ...
    $SportTouring,
    $Cross,
    $listMember = ['jormungandr', 'musphelheim', 'svartalheim', 'metaphoserin', 'vanaheim', 'niflheim', 'midgard', 'asgard', 'jotunheim'];
...
class rental extends Data {
    ...
    public function pembayaran () {
        echo '<center>';
        echo strtoupper("<b>$this->member</b>") . ' berstatus sebagai ' . $this->getMember() . ' mendapatkan diskon sebesar ' . $this->hargaRental()[1] . '%';
        echo '<br>';
